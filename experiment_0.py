...
def exp000(t_max: Optional[float] = None ,
	...
	axins = inset_axes(axs[0],width="20%",height="35%",loc="upper right", bbox_to_anchor=(0.05, 0.03, 0.95, 0.95),bbox_transform=axs[0].transAxes)
	...
	axs[1].plot(t/tau,d_dde_dt,'k')
	axs[1].plot(t/tau,d_ww_dt,color ='lightskyblue',linestyle='dashed')
